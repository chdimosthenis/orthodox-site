...
Ο τελώνης δεν τολμά καν να σηκώσει τα μάτια. Στέκεται μακριά, χτυπά το στήθος του, λέει επτά λέξεις: «Ὁ Θεός, ἱλάσθητί μοι τῷ ἁμαρτωλῷ». Δεν απαριθμεί αρετές γιατί δεν έχει· δεν συγκρίνεται με κανέναν γιατί ο μόνος του ορίζοντας είναι η ίδια του η ανάγκη. Η προσευχή του είναι αλήθεια χωρίς διακοσμήσεις.
